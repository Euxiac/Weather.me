...
const Widget_Game = () => {
    ...
    const handleGuessSubmit = () => {
        ...
        if (userGuess === targetNumber) {
            setMessage(`Correct! You guessed the of ducks in ${attempts + 1} attempts.`);
        ...
        <>
            <CardContent>
                ...
                <Typography variant="body1" align="center" gutterBottom>
                    How many ducks are crossing the road? Guess a number between 1 and 100.
                </Typography>
            ...
            <CardActions>
                <Button fullWidth variant="outlined" color="primary" onClick={handleResetGame}>
                    Reset Game
                </Button>
            </CardActions>
        </>
